...
<body>
    ...
    <div class="splash-container">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?=site_url('login/simpan_password')?>" id="simpan_password" method="post">
                    <?php $key = $this->uri->segment(3);?>
                    <input type="hidden" name="key" value="<?=$key?>">
                    <div class="form-group">
                        <input class="form-control form-control-lg" type="text" name="password_baru" required placeholder="password baru" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <input class="form-control form-control-lg" type="tex" name="password_con" required placeholder="konfirmasi password" autocomplete="off">
                    </div>
