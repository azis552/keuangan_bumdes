                    ...
                    <div class="card">
                            ...
                            <button id="tambah_trans" type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal">
                                ...
                                <div class="modal-dialog" role="document">
                                    ...
                                    <form action="<?= site_url('bendahara_pegawai/input_jurnal_penyesuaian')?>" method="POST" id="tambah_transaksi" name="tambah_transaksi" >
                        ...
                        <div class="ml-2 mt-2">
                        <form action="<?= site_url('bendahara_pegawai/tambah_det_penyesuaian')?>" method="POST" id="tambah_det_transaksi" name="tambah_det_transaksi" >
                            <div class="form-group">
